        ...
        <footer class="wrapper">
            <div class="wrapper__group">
                <div class="footer__logo">
                    <MainLogo :lightMode="true">Travala</MainLogo>
                    <div class="footer__desc">
                        With travala you can experience new travel and the best tourist destinations that we have to
                        offer
                    </div>
                </div>
                <div class="footer__links">
                    <div class="footer__wrapper">
                        <h3 class="footer__header">Destination</h3>
                        <ul class="footer__list">
                            <li class="footer__item">
                                <RouterLink to="/cappadocia" class="footer__link">Cappadocia</RouterLink>
                            </li>
                            <li class="footer__item">
                                <RouterLink to="/sossusvlei" class="footer__link">Sossusvlei</RouterLink>
                            </li>
                            <li class="footer__item">
                                <RouterLink to="/albuquera" class="footer__link">Albuquera</RouterLink>
                            </li>
                        </ul>
                    </div>
                    <div class="footer__wrapper">
                        ...
                        <ul class="footer__list">
                            ...
                            <li class="footer__item">
                                <RouterLink to="/testimoni" class="footer__link">Testimoni</RouterLink>
                            </li>
                            <li class="footer__item">
                                <RouterLink to="/rating" class="footer__link">Rating</RouterLink>
                            </li>
                        </ul>
                    </div>
                    <div class="footer__wrapper">
                        ...
                        <ul class="footer__list">
                            <li class="footer__item">
                                <RouterLink to="/facebook" class="footer__link footer__link--social">
                            ...
                            <li class="footer__item">
                                <RouterLink to="/twitter" class="footer__link footer__link--social">
                            ...
                            <li class="footer__item">
                                <RouterLink to="/instagram" class="footer__link footer__link--social">
            ...
            <div class="footer__copyright">
                <p class="footer__text">Copyright © Travala 2021</p>
                <div class="footer__terms">
                    <RouterLink to="/terms" class="footer__link">Terms & Conditions</RouterLink>
